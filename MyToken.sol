...
contract MyToken is ERC20, Ownabl
    ...
    // यहाँ 1000 टोकन बनाए जा रहे हैं। 
    ...
    // यह फ़ंक्शन केवल कॉन्ट्रैक्ट के मालिक (Owner) द्वारा कॉल किया जा सकता ह
    function mint(address to, uint256 amount) public onlyO
